...
if __name__ == "__main__":
    ...
    headlabel = Label(root, text='welcome to Real Time Currency Convertor',
                      fg='white', bg="red", font="bold")

    # Create a "Amount :" label
    label1 = Label(root, text="Amount :", fg='white', bg='dark green')

    # Create a "From Currency :" label
    label2 = Label(root, text="From Currency", fg='white', bg='dark green')

    # Create a "To Currency: " label
    label3 = Label(root, text="To Currency :", fg='white', bg='dark green')
    ...
    button1 = Button(root, text="Convert", bg="red",
                     fg="black", command=RealTimeCurrencyConversion)
